...
<html>
    ...
    <body> -->
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <!-- <h2 style="margin-top:0px">T04_rincian List</h2> -->
                <?php if ($hakAkses['tambah']) { ?>
                <?php echo anchor(site_url('t04_rincian/create'), 'Tambah', 'class="btn btn-primary"'); ?>
                <?php } ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "t04_rincian/json", "type": "POST",
                        "data": function(data) {
                ...
                const aName = ['', 'tahun_ajaran', 'sekolah', 'kelas', ''];
