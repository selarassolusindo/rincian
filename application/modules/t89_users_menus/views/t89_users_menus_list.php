...
<html>
    ...
    <body> -->
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <!-- <h2 style="margin-top:0px">T89_users_menus List</h2> -->
                <?php echo anchor(site_url('t89_users_menus/create'), 'Tambah', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "t89_users_menus/json", "type": "POST",
                        "data": function(data) {
                ...
                const aName = ['', 'idusers', 'idmenus', 'rights', ''];
