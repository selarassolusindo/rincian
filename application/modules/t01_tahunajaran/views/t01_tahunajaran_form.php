...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">T01_tahunajaran <?php echo $button ?></h2> -->
            ...
            <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
                <div class="box-body">
					<div class="form-group">
                        <label class="col-sm-2 control-label" for="varchar">Tahun Ajaran <?php echo form_error('tahun_ajaran') ?></label>
                        <div class="col-sm-3">
                ...
                <div class="box-footer">
                    ...
                    <a href="<?php echo site_url('t01_tahunajaran') ?>" class="btn btn-default">Batal</a>
                </div>
