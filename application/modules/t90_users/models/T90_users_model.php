...
class T90_users_model extends CI_Model
{

    public $table = 't90_users';
    public $id = 'id';
    public $order = 'DESC';
    ...
    function json() {
        ...
        $this->datatables->from('t90_users');
        ...
        //$this->datatables->join('table2', 't90_users.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('t90_users/update/$1'),'Ubah')." | ".anchor(site_url('t90_users/delete/$1'),'Hapus','onclick="javascript: return confirm(\'Apakah Anda yakin ingin menghapus data ?\')"'), 'id');
...
/* End of file T90_users_model.php */
/* Location: ./application/models/T90_users_model.php */
